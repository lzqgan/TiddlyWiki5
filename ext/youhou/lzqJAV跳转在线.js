...
(function (preact) {
  ...
  const siteList = [
     {
      name: "javchass",
      hostname: "javclass.com",
      url: "https://javclass.com/movies/{{code}}/",
      fetchType: "get",
      domQuery: {videoQuery: ".data"}
     },
    {
      name: "FANZA 動画",
      hostname: "dmm.co.jp",
    ...
    },
    {
      name: "123av",
      hostname: "1av.to",
      url: "https://1av.to/zh/search?keyword={{code}}",
      fetchType: "parser",
      strictParser: true,
      domQuery: {
